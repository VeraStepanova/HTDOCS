...
$book4 = new Book(array('title' => 'Webbredaktörens skrivhandbok : klarspråk på nätet
av Karin Guldbrand, Helena Englund Hjalmarsson', 'description' => 'Webbredaktörens skrivhandbok är en praktisk
handbok för dig som arbetar med texter, mikrocopy
och form för webb, surfplattor och mobiltelefoner.
Författarna tar ett språkligt grepp på användbarhet
och visar hur språket samspelar med andra element
på sidan. Boken ger dig vägledning och konkreta
tips och råd för alla delar av textproduktionen,
i utvecklingsfasen såväl som i förvaltningsfasen.', 'image' => 'https://image.bokus.com/images/9789198125047_200x_webbredaktorens-skrivhandbok-klarsprak-pa-natet_haftad', 'price' => '429 kr'));
$book5 = new Book(array('title' => 'Webbutveckling med PHP och MySQL
av Montathar Faraon', 'description' => 'PHP är ett av de ledande programmeringsspråken för webbutveckling. Det är ett flexibelt och enkelt språk som används för att skapa dyna miska webbplatser. Denna bok ger en lättillgänglig introduktion till PHP och databashantering. Läsaren får den kunskap som krävs för att snabbt utveckla egna webbapplikationer.', 'image' => 'https://image.bokus.com/images/9789144105567_200x_webbutveckling-med-php-och-mysql_haftad', 'price' => '391 kr'));
$book6 = new Book(array('title' => 'Artificial Intelligence: A Modern Approach, Global Edition
av Stuart Russell', 'description' => 'For one or two-semester, undergraduate or graduate-level courses in Artificial Intelligence. The long-anticipated revision of this best-selling text offers the most comprehensive, up-to-date introduction to the theory and practice of artificial intelligence.', 'image' => 'https://image.bokus.com/images/9781292153964_200x_artificial-intelligence-a-modern-approach-global-edition_haftad', 'price' => '659 kr'));
